...
const Navbar = () => {
    ...
    const navEnd = <>
        ...
        <FaUserCircle className="text-4xl cursor-pointer"></FaUserCircle>
        ...
        <div className="navbar bg-base-100 bg-opacity-80 fixed z-[100]">
            ...
            <div className="navbar-end gap-2 lg:hidden">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52 right-0 text-xl font-bold">
