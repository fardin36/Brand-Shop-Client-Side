...
const Products = () => {
    return (
        <div className="min-h-screen flex justify-center items-center pt-10">
            ...
            <div className="w-full max-w-sm border border-[#ffb300] rounded-lg shadow-xl">
                <div className="h-52 flex justify-center items-center">
                    <img className="p-2 h-full rounded-t-lg" src="https://i.ibb.co/HYLHMbk/iPhoneX.png" alt="product image" />
                </div>
