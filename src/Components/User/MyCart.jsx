            ...
            <div className="min-h-screen pt-20">
                ...
                <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0">
                    <div className="rounded-lg md:w-2/3 flex flex-col gap-4">
                        {
                            cartItems.map(item => <div key={item._id} className="border flex justify-between items-center rounded-lg glass shadow-2xl p-2">
                                ...
                                <div>
                                    <button className="btn btn-square btn-outline rounded-lg btn-sm">
